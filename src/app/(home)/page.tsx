  ...
  return (
    <main>
      ...
      <section className="my-10 md:my-0 md:h-screen flex flex-col justify-center items-center gap-y-6 md:gap-y-10">
        ...
        <div className="relative w-full bg-neutral-950 flex flex-col items-center gap-y-4 rounded-md p-2 md:p-4">
          ...
          <button className="relative w-fit bg-neutral-200 text-[0.8rem] text-neutral-900 px-4 py-1 rounded">
            Sign Up
          </button>
        </div>
      </section>
